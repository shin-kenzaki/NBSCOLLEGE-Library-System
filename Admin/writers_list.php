...
if (isset($_POST['action']) && $_POST['action'] === 'deleteWriter') {
    ...
    try {
        ...
        $deleteContributorsSql = "DELETE FROM individual_contributors WHERE writer_id = $writerId";
    ...
    if (empty($selectedIds)) {
        ...
        try {
            foreach ($selectedIds as $id) {
                // Delete associated individual contributors
                $deleteContributorsSql = "DELETE FROM individual_contributors WHERE writer_id = $id";
                $conn->query($deleteContributorsSql);
