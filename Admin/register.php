...
<?php
    session_start();
    include '../db.php';
    include '../Admin/inc/register.php'
...
<body class="bg-gradient-primary">
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control form-control-user" name="id" placeholder="User ID" required>
        </div>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-user" name="middle_int" placeholder="Middle Initial">
        </div>
        <div class="col-sm-6">
