...
<nav aria-label="Fines pagination">
    <ul class="pagination justify-content-center mt-4">
        ...
        if ($startPage > 1) {
            ...
            echo '<a class="page-link fpagination-link" href="#" data-page="1">1</a></li>';
        ...
        for ($i = $startPage; $i <= $endPage; $i++) {
            if ($i > 1 && $i < $totalPages) {  // Skip first and last page since they're handled separately
                ...
                echo '<a class="page-link fpagination-link" href="#" data-page="' . $i . '">' . $i . '</a></li>';
            }
        }
        ...
        if ($endPage < $totalPages) {
            ...
            echo '<a class="page-link fpagination-link" href="#" data-page="' . $totalPages . '">' . $totalPages . '</a></li>';
        }
        ?>
